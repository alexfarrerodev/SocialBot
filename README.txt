...
How to Use
Download the executable or run the program using run.bat.
If you see a terminal window open without any output, this means the bot is currently running in the background and actively scanning the screen for the specified images.
Use the keyboard shortcuts to control the bot’s behavior as described in the CONTROLS section.
Important Notes
...
License
This project is open-source and licensed under the MIT License. You are free to use, modify, and distribute it, but please ensure that you provide proper credit to the original author. Use this tool at your own risk.

Release
You can find the latest release and download the executable from the official GitHub release page.
...
This README provides clear instructions, features, and licenses the program under the MIT License while ensuring you give proper credit when distributing or using the software.
